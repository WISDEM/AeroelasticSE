...
from AD_temp import ADInputReader, ADInputWriter
...
#    model_path = 'C:/Python27/openmdao-0.9.2/aeroelasticSE/AeroelasticSE/src/AeroelasticSE/ModelFiles/'
    ...
    def __init__(self, geometry=None, atm=None, debug=False):
        ...
        self.ad_new_file = ''
        self.ad_input = ADInputReader()
        self.ad_writer = ADInputWriter()
        self.ts_file = None
        self.ptfm_file    = None
...
#            print "hdr_i , paramname", hdr[i].strip(), paramname
    ...
    def readAD(self):
        ...
        self.ad_input.master_file = fname
        self.ad_input.execute()
    ...
    def writeAD(self):
        ...
        self.ad_writer.aero_vt = self.ad_input.aero_vt
        self.ad_writer.execute()        
        self.ad_new_file = self.ad_writer.master_file
