...
class FST7Workflow (Component):
	...
	def __init__(self, config, case):
		...
		"""
		super(FST7Workflow, self).__init__()

		# Initialize objects
		self.reader = Fst7InputReader()
		self.writer = Fst7InputWriter()
		self.wrapper = Fst7Wrapper()
		...
		self.outsize = ((self.writer.fst_vt.fst_sim_ctrl.TMax - self.writer.fst_vt.ed_out_params.TStart) \
