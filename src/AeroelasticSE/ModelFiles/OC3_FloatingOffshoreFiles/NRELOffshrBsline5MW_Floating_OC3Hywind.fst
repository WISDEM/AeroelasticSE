...
---------------------- INITIAL CONDITIONS --------------------------------------
  3.42  	  OoPDefl     - Initial out-of-plane blade-tip displacement (meters)
 -0.3016  	IPDefl      - Initial in-plane blade-tip deflection (meters)
  0.0       TeetDefl    - Initial or fixed teeter angle (degrees) [unused for 3 blades]
  0.0       Azimuth     - Initial azimuth angle for blade 1 (degrees)
  9.13	  	RotSpeed    - Initial or fixed rotor speed (rpm)
  0.0     	NacYaw      - Initial or fixed nacelle-yaw angle (degrees)
  0.2341	  TTDspFA     - Initial fore-aft tower-top displacement (meters)
 -0.02038	  TTDspSS     - Initial side-to-side tower-top displacement (meters)
