--------------------------------------------------------------------------------
------- FAST INPUT FILE --------------------------------------------------------
NREL 5.0 MW Baseline Wind Turbine for Use in Offshore Analysis.  Sea-based, monopile with rigid foundation.
...
True        CompNoise   - Compute aerodynamic noise (flag)
---------------------- INITIAL CONDITIONS --------------------------------------
...
---------------------- NOISE ---------------------------------------------------
"Noise.v7.02.ipt"            NoiseFile   - Name of file containing aerodynamic noise input parameters (quoted string) [used only when CompNoise=True]
---------------------- ADAMS ---------------------------------------------------
...
"Azimuth"        - Blade 1 azimuth angle   (deg)
"RotSpeed"       - Low-speed shaft speed   (rpm)
"BldPitch1"      - Blade 1 pitch angle     (deg)
"RotTorq, RotPwr, RotThrust"        - Rotor torque,power, thrust, power
